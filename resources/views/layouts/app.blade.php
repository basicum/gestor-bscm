...
<div class="container-scroller">
            ...
            <ul class="navbar-nav navbar-nav-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="#" data-toggle="dropdown">
                        ...
                        <span class="count">{{count($proyectos->proyectos)}}</span>

                    </a>
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">

                        <p class="mb-0 font-weight-normal float-left dropdown-header">Estas trabajando en {{count($proyectos->proyectos)}} proyectos</p>
                        @foreach($proyectos->proyectos as $proyecto)
                        <a href="okproyecto.php?var={{$proyecto->id}}" class="dropdown-item preview-item">
                            ...
                            <div class="preview-item-content">
                                <h6 class="preview-subject font-weight-normal">{{$proyecto->descripcion}}</h6>
                                <p class="font-weight-light small-text mb-0 text-muted">
                                    <span class="percent">{{$proyecto->sumahoras}}</span>
                                </p>
                            </div>
                        </a>
                      @endforeach
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link count-indicator dropdown-toggle d-flex justify-content-center align-items-center" id="messageDropdown" href="#" data-toggle="dropdown">
                        ...
                        <span class="count">{{count($ord_trabajo->ord_trabajo)}}</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                        <p class="mb-0 font-weight-normal float-left dropdown-header">Tareas Pendientes ({{count($ord_trabajo->ord_trabajo)}})</p>
                        @foreach ($ord_trabajo->ord_trabajo as $tarea)
                        ...
                        <a class="dropdown-item preview-item">
                            ...
                            <div class="preview-item-content flex-grow">
                                <h6 class="preview-subject ellipsis font-weight-normal">{{utf8_decode( $tarea->ampltexto )}}
                                </h6>
                                <p class="font-weight-light small-text text-muted mb-0">
                                  Cliente  {{$tarea->abrevi}}
                                </p>
                            </div>
                        </a>
                        @endforeach
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="#" data-toggle="dropdown">
                        ...
                        <span class="count">{{$total_presupuestos}}</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                        <p class="mb-0 font-weight-normal float-left dropdown-header">Presupuestos</p>
                        @foreach ($total_presupuestos_pendientes->tpp as $presup)
                        <a class="dropdown-item preview-item">
                            <div class="preview-thumbnail">
                                <div class="preview-icon bg-success">
                                    <i class="ti-info-alt mx-0"></i>
                            ...
                            <div class="preview-item-content">
                                <h6 class="preview-subject font-weight-normal">{{$presup->id_cliente }} - {{$presup->fecha_pres }}- {{$presup->suma_imp }}€ ({{$presup->clestadopresu }})</h6>
                                <p class="font-weight-light small-text mb-0 text-muted">
                                    {{utf8_decode( $presup->descripcion )}}
                                </p>
                            </div>
                        </a>
                        @endforeach
                ...
                <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown" aria-expanded="false">
                            <img src="img/{{   $usuarios->foto }}" alt="profile">
                        </a>
    ...
    <div class="container-fluid page-body-wrapper">
        {{--slider de la derecha aparece al pulsar los 3 puntos--}}
                ...
                <div class="tab-pane fade show active scroll-wrapper ps" id="todo-section" role="tabpanel" aria-labelledby="todo-section">
                    ...
                    <div class="list-wrapper px-3">
                        <ul class="d-flex flex-column-reverse todo-list">
                            ...
                            <li>
                                {{--se puede cambiar a class="completed"--}}
