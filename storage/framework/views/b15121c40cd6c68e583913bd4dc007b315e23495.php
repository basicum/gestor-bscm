                    ...
                    <div class="card bg-primary border-0 position-relative">
                        <div class="card-body">
                            ...
                            <div id="performanceOverview" class="carousel slide performance-overview-carousel position-static pt-2" data-ride="carousel">
                                ...
                                <a class="carousel-control-prev" href="http://www.urbanui.com/justdo/template/demo/vertical-boxed/index.html#performanceOverview" role="button" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="sr-only">Previous</span>
                                </a>
                                <a class="carousel-control-next" href="http://www.urbanui.com/justdo/template/demo/vertical-boxed/index.html#performanceOverview" role="button" data-slide="next">
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                            ...
                            <p class="text-muted font-weight-light">The total number of sessions within the date range. It is the period time a user is actively engaged with your website, page or app, etc</p>
                            <div id="sales-legend" class="chartjs-legend mt-4 mb-2"><ul class="1-legend"><li><span style="background-color:#ffc100"></span>Offline Sales</li><li><span style="background-color:#f5a623"></span>Online Sales</li></ul></div>
                            ...
                            <div class="d-flex justify-content-center justify-content-md-end">
                                <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2">
                                        <a class="dropdown-item" href="http://www.urbanui.com/justdo/template/demo/vertical-boxed/index.html#">January - March</a>
                                        <a class="dropdown-item" href="http://www.urbanui.com/justdo/template/demo/vertical-boxed/index.html#">March - June</a>
                                        <a class="dropdown-item" href="http://www.urbanui.com/justdo/template/demo/vertical-boxed/index.html#">June - August</a>
                                        <a class="dropdown-item" href="http://www.urbanui.com/justdo/template/demo/vertical-boxed/index.html#">August - November</a>
                                    </div>
                                </div>
