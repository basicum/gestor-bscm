                ...
                <div class="col-md-12 grid-margin">
                    ...
                    <div class="row">
                        <div class="col-12 col-xl-4 mb-4 mb-xl-0">
                            <h4 class="font-weight-bold">Hola, <?php echo e(Auth::user()->name); ?> </h4>
                        ...
                        <div class="col-12 col-xl-8">
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                <div class="border-right pr-4 mb-3 mb-xl-0">
                                    ...
                                    <h4 class="mb-0 font-weight-bold"><?php echo e($ingresos); ?> €</h4>
                                </div>
                                <div class="border-right pr-4 mb-3 mb-xl-0">
                                    <p class="text-muted">Gastos</p>
                                    <h4 class="mb-0 font-weight-bold"><?php echo e($gastos); ?> €</h4>
                                </div>
                                <div class="border-right pr-4 mb-3 mb-xl-0">
                                    <p class="text-muted">Proyectos</p>
                                    <h4 class="mb-0 font-weight-bold"><?php echo e($total_proyectos->total); ?></h4>
                                </div>
                                <div class="pr-3 mb-3 mb-xl-0">
                                    <p class="text-muted">Presupuestos</p>
                                    <h4 class="mb-0 font-weight-bold"><?php echo e($total_presupuestos_activos); ?></h4>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                                <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"><?php echo e($total_presupuestos_activos); ?></h3>
                                <i class="ti-calendar icon-md text-muted mb-0 mb-md-3 mb-xl-0"></i>
                            </div>
                            <p class="mb-0 mt-2 text-warning"><?php echo e(round($presupuestos,2)); ?>% <span class="text-black ml-1"><small>(Aceptados)</small></span></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                                <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"><?php echo e($clientes); ?></h3>
                                <i class="ti-user icon-md text-muted mb-0 mb-md-3 mb-xl-0"></i>
                            </div>
                            <p class="mb-0 mt-2 text-danger"><?php echo e(round($ratio_clientes,2)); ?>% <span class="text-black ml-1"><small>(Mis Clientes)</small></span></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                                <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"><?php echo e($total_proyectos->total); ?></h3>
                                <i class="ti-agenda icon-md text-muted mb-0 mb-md-3 mb-xl-0"></i>
                            </div>
                            <p class="mb-0 mt-2 text-success"><?php echo e(round($ratio_proyectos, 2)); ?>%<span class="text-black ml-1"><small>(Mis proyectos)</small></span></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                                <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"><?php echo e($total_trabajos); ?></h3>
                                <i class="ti-layers-alt icon-md text-muted mb-0 mb-md-3 mb-xl-0"></i>
                            </div>
                            <p class="mb-0 mt-2 text-success"><?php echo e(round($ratio_trabajos, 2)); ?>%<span class="text-black ml-1"><small>(Mis trabajos)</small></span></p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-borderless table-hover ">
                                    ...
                                    <?php foreach($facturas->facDesde as $factura): ?>

                                    <tr>

                                        <td> <a href="verfactura/<?php echo e($factura->facnumero); ?>"><?php echo e($factura->facnumero); ?> </a></td>
                                             <?php 
                                        ...
                                        <td><?php echo e(utf8_decode($factura->abrevi)); ?></td>
                                        <td class="font-weight-bold"><?php echo e($factura->facimp); ?>€</td>
                                        <td><?php echo e($factura->facdma); ?></td>
                        ...
                        <div class="card-body">
                            ...
                            <div class="list-wrapper pt-2">
                                <ul class="d-flex flex-column-reverse todo-list todo-list-custom">
                                  <?php foreach($notas as $nota): ?>
                                    <li>
                                        ...
                                        <div style="horiz-align:right"> <a href="<?php echo e(route('notas.update', $nota->id)); ?>">   (Borrar)</a></div>
                                ...
                                <div class="add-items d-flex mb-0 mt-2">
                                    <form action="<?php echo e(route('notas.crear')); ?>" style="width: 260px;"  method="GET">
                        ...
                        <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                            ...
                            <div class="d-flex flex-wrap mb-5">
                                <div class="mr-5 mt-3">
                                    ...
                                    <h3><?php echo e($total_presupuestos_activos); ?></h3>
                                </div>
                                <div class="mr-5 mt-3">
                                    <p class="text-muted">Total Proyectos</p>
                                    <h3><?php echo e($total_proyectos->total); ?> </h3>
                                </div>
                                <div class="mr-5 mt-3">
                                    <p class="text-muted">Total Usuario</p>
                                    <h3><?php echo e(round($ratio_trabajos, 2)); ?>%</h3>
                                </div>
                            </div>
