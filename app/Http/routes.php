...
Route::get('/modif_tercero-{id}', 'TercerosController@visualizaTercero' )->name('modif_tercero');
Route::get('/modif_tercero{id}', 'TercerosController@actualizarTercero' )->name('terceros.update');
